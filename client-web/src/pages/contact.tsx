...
const contactInfo = [
	{
		...
		title: 'Address',
		details: [
			'AIC GISC, GISC, Design Innovation Centre (DIC)',
				...
				<div className="max-w-7xl px-6 lg:px-16 text-start">
					...
					>
						...
						<p className="text-lg md:text-xl text-muted-foreground max-w-3xl">
							Have questions about our programs or want to learn more about the GTU
							Ventures ecosystem? We're here to help you on your entrepreneurial
							journey.
						</p>
					</motion.div>
				</div>
				...
				<div className="mx-auto px-6 lg:px-16">
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch">
								...
								<CardContent className="p-8 flex flex-col h-full">
									...
									<Form {...form}>
										<form
											...
											className="flex flex-col h-full sm:gap-5 gap-10"
										>
						...
						<motion.div
							...
							animate={{ opacity: 1, x: 0 }}
							transition={{ duration: 0.6 }}
							className="space-y-5 flex flex-col self-stretch"
						>
							<div className="flex-1 space-y-5">
								<div>
									...
									<p className="text-muted-foreground leading-relaxed">
										We're here to support your entrepreneurial journey. Whether
										you're a student with an idea, an investor looking for
										opportunities, or a partner wanting to collaborate, we'd
							...
							<motion.div
								...
								className="rounded-lg overflow-hidden shadow-lg flex-none w-full"
							>
