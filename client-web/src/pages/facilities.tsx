...
export default function Facilities() {
	...
	return (
		<PageShell
			...
			subtitle="Infrastructure, labs, and services available to startups at GTU Ventures."
		>
								...
								<div className="p-8 flex flex-col flex-1">
									...
									{it.actions?.length > 0 && (
										<div className="flex flex-wrap gap-2 mt-4">
											{it.actions.map((action: string, idx: number) => (
												<span
													key={idx}
			...
			>
				<div className="text-center mb-12">
					...
					<div className="w-24 h-1 bg-primary mx-auto rounded-full"></div>
					<p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
						Downloadable templates and resources to support your startup development
					</p>
				</div>
					...
					{selectedFacility && (
						<>
							...
							<div className="space-y-4">
								{(selectedFacility.body || selectedFacility.description) && (
								...
								{selectedFacility.actions?.length > 0 && (
									<div className="flex flex-wrap gap-2 pt-4">
										{selectedFacility.actions.map((a: string, idx: number) => (
											<span
												key={idx}
								...
								{selectedFacility.download && selectedFacility.download !== '#' && (
									<div className="pt-4">
										<Button asChild className="w-full">
											<a href={selectedFacility.download} download>
