				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
					...
					<a href="/startups" className="group">
						<motion.div
							...
							className="lg:row-span-1 bg-gradient-to-br from-white to-gray-50 rounded-3xl p-8 shadow-md hover:shadow-xl transition-shadow transition-transform duration-300 card-hover cursor-pointer group overflow-hidden min-h-[260px] md:min-h-[320px]"
						>
							<div className="flex items-start justify-between mb-6">
								<div className="flex-1">
									<h3 className="text-2xl lg:text-3xl font-bold text-foreground mb-4 group-hover:text-purple-600 transition-colors">
					...
					<a href="/programs" className="group block" aria-label="Find Your Program">
						<motion.div
							whileHover={{ y: -6, scale: 1.02 }}
							className="relative bg-white rounded-3xl overflow-hidden shadow-md hover:shadow-xl card-hover cursor-pointer group transition-transform duration-300 min-h-[260px] md:min-h-[320px]"
						>
					...
					<a href="/apply" className="group">
						<motion.div
							whileHover={{ y: -6, scale: 1.02 }}
							className="rounded-3xl p-8 shadow-md hover:shadow-xl card-hover cursor-pointer group text-white transition-transform duration-300 min-h-[260px] md:min-h-[320px] bg-[#7247bd]"
						>
							<div className="flex items-start justify-between mb-6">
								<div className="flex-1">
									...
									<h3 className="text-2xl lg:text-3xl font-extrabold mb-4 group-hover:text-purple-100 transition-colors">
