              ...
              {programLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    ...
                    data-testid={`footer-program-${link.name.toLowerCase().replace(/\s+/g, '-')}`}
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 text-sm text-white/80">
              <div className="flex items-center gap-4">
                <span data-testid="contact-phone" className="flex items-center gap-2">
                  <span className="text-white/60">📞</span> 9909910798
                </span>
                <span data-testid="contact-email" className="flex items-center gap-2">
